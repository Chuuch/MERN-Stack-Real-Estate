      ...
      {listing && !loading && !error && (
        <div>
          ...
          <div className='flex flex-col max-w-4xl mx-auto p-3 my-7 gap-4'>
            ...
            <p className='flex items-center mt-6 gap-2 text-slate-600 dark:text-slate-500 text-sm'>
            ...
            <div className='flex gap-4'>
              ...
              {listing.offer && (
                <p className='bg-green-900 dark:text-green-600 w-full max-w-[200px] text-white text-center p-1 rounded-md'>
                  ${+listing.regularPrice - +listing.discountPrice} OFF
                </p>
              )}
            </div>
            <p className='text-slate-800 dark:text-slate-600'>
              <span className='font-semibold text-black dark:text-slate-500'>Description - </span>
              {listing.description}
            </p>
